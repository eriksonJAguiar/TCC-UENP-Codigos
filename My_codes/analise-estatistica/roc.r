...
FPR<-read.csv2("/media/erikson/BackupLinux/Documentos/UENP/4 º ano/TCC/TCC-UENP-Codigos/Material/My_codes/files_extern/roc-en.csv", sep=",", dec = ".")[1:30,2:7]
TPR<-read.csv2("/media/erikson/BackupLinux/Documentos/UENP/4 º ano/TCC/TCC-UENP-Codigos/Material/My_codes/files_extern/roc-en.csv", sep=",",dec = ".")[31:60,2:7]
